...
public class AndroidPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public static final String FLET_ANDROID_PLUGIN_JAVA_CLASS_NAME = "FLET_ANDROID_PLUGIN_JAVA_CLASS_NAME";
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding activityPluginBinding) {
    ...
    try {
      Os.setenv(FLET_ANDROID_PLUGIN_JAVA_CLASS_NAME, this.getClass().getCanonicalName(), true);
    } catch (Exception e) {
      // nothing to do
    }
  }
